...
namespace move::vectormath
{
    ...
    public:
        ...
        RTM_FORCE_INLINE generic_quat(value_type x, value_type y = 0,
            value_type z = 0, value_type w = 0) noexcept
            : _value(rtm::quat_normalize((rtm::quat_set(x, y, z, w))))
        {
        }

        RTM_FORCE_INLINE generic_quat(const quat_type& v) noexcept : _value(v)
        {
        }

    public:
        RTM_FORCE_INLINE quat_type get_internal() const noexcept
        {
            return _value;
        }
    ...
    public:
        RTM_FORCE_INLINE operator quat_type&()
        {
            return _value;
        }

        RTM_FORCE_INLINE bool operator==(const generic_quat& v) const noexcept
        {
        ...
        RTM_FORCE_INLINE generic_quat& operator=(const generic_quat& v) noexcept
        {
            _value = v._value;
            return *this;
        }

        RTM_FORCE_INLINE generic_quat& operator*=(
        ...
        RTM_FORCE_INLINE generic_quat operator-() const noexcept
        {
    ...
    public:
        ...
        public:
            RTM_FORCE_INLINE component_accessor(
                generic_quat& vec, int index) noexcept
        ...
        RTM_FORCE_INLINE generic_quat& set_x(value_type x) noexcept
        {
            _value = rtm::vector_set_x(_value, x);
            return *this;
        }

        RTM_FORCE_INLINE generic_quat& set_y(value_type y) noexcept
        {
            _value = rtm::vector_set_y(_value, y);
            return *this;
        }

        RTM_FORCE_INLINE generic_quat& set_z(value_type z) noexcept
        {
            _value = rtm::vector_set_z(_value, z);
            return *this;
        }

        RTM_FORCE_INLINE generic_quat& set_w(value_type w) noexcept
        {
    ...
    public:
        RTM_FORCE_INLINE bool is_nan() const noexcept
        {
            return !rtm::quat_is_finite(_value);
        }

        RTM_FORCE_INLINE bool is_infinite() const noexcept
        {
            return !rtm::quat_is_finite(_value);
        }

        RTM_FORCE_INLINE bool is_identity() const noexcept
        {
        ...
        RTM_FORCE_INLINE generic_quat normalized() const noexcept
        {
            return generic_quat(rtm::quat_normalize(_value));
        }

        RTM_FORCE_INLINE generic_quat normalized_approximate() const noexcept
        {
            // TODO: Approximate?
            return generic_quat(rtm::quat_normalize(_value));
        }

        RTM_FORCE_INLINE value_type dot(const generic_quat& v) const noexcept
        {
            return rtm::quat_dot(_value, v._value);
        }

        RTM_FORCE_INLINE generic_quat conjugate() const noexcept
        {
            return generic_quat(rtm::quat_conjugate(_value));
        }

        RTM_FORCE_INLINE generic_quat inverse() const noexcept
        {
        ...
        // TODO
        // RTM_FORCE_INLINE generic_quat ln() const noexcept
        // {
        //     return generic_quat(rtm::ext::quat_ln(_value));
        // }

        // RTM_FORCE_INLINE generic_quat exp() const noexcept
        // {
        //     // return generic_quat(rtm::ext::quat_exp(_value));
        // }

        RTM_FORCE_INLINE generic_quat slerp(
            const generic_quat& v, value_type t) const noexcept
        {
            return generic_quat(rtm::quat_lerp(_value, v._value, t));
        }

        static RTM_FORCE_INLINE generic_quat slerp(const generic_quat& v1,
    ...
    public:
        static RTM_FORCE_INLINE generic_quat identity() noexcept
        {
            return generic_quat(rtm::quat_identity());
        }

        // RTM_FORCE_INLINE static generic_quat barycentric(const generic_quat&
        // q0,
        ...
        // RTM_FORCE_INLINE static generic_quat barycentric_v(const
        // generic_quat& q1,
        ...
        static RTM_FORCE_INLINE generic_quat from_pitch_yaw_roll(
        ...
        static RTM_FORCE_INLINE generic_quat from_axis_angle(
        ...
        static RTM_FORCE_INLINE generic_quat from_rotation_normal(
        ...
        static RTM_FORCE_INLINE generic_quat from_rotation_axis(
            const vec3_type& axis, value_type angle) noexcept
        {
            return generic_quat(
                rtm::quat_from_axis_angle(axis.get_internal(), angle));
        ...
        static RTM_FORCE_INLINE generic_quat rotation_matrix_to_quaternion(
