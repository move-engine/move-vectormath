...
namespace move::vectormath
{
    ...
    // mat4
    MVM_INL generic_mat4 generic_mat4::create_look_at_rh(
    ...
    MVM_INL generic_mat4 generic_mat4::create_look_at_lh(
        const vec3& eye, const vec3& target, const vec3& up) noexcept
    {
        return generic_mat4(
    ...
    MVM_INL generic_mat4 generic_mat4::create_look_at(
        const vec3& eye, const vec3& target, const vec3& up) noexcept
    {
        return generic_mat4(
    ...
    MVM_INL generic_mat4 generic_mat4::create_transformation_matrix(
        const vec3& translation, const quat& rotation,
        const vec3& scale) noexcept
    {
        return generic_mat4(fastmat4::create_transformation_matrix(
