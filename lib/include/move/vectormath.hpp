...
struct Matrix4 : public XMFLOAT4X4
{
  ...
  explicit Matrix4(const Vector3& r0,
                   const Vector3& r1,
  ...
  explicit Matrix4(const Vector4& r0,
                   const Vector4& r1,
                   const Vector4& r2,
  ...
  static Matrix4 CreatePerspective(float width,
                                   ...
                                   float nearPlane,
                                   float farPlane) noexcept;
  static Matrix4 CreatePerspectiveOffCenter(float left,
                                            float right,
                                            float bottom,
                                            float top,
                                            float nearPlane,
  ...
  static Matrix4 CreateOrthographicOffCenter(float left,
                                             float right,
                                             float bottom,
                                             float top,
                                             float zNearPlane,
  ...
  // (roll)
  static Matrix4 CreateFromYawPitchRoll(float yaw,
                                        float pitch,
                                        float roll) noexcept;

  // Rotates about y-axis (angles.y), then x-axis (angles.x), then
  // z-axis (angles.z)
  static Matrix4 CreateFromYawPitchRoll(const Vector3& angles) noexcept;

  static Matrix4 CreateShadow(const Vector3& lightDir,
                              const Plane& plane) noexcept;

  static Matrix4 CreateReflection(const Plane& plane) noexcept;

  static void Lerp(const Matrix4& M1,
                   const Matrix4& M2,
                   float t,
  ...
  static void Transform(const Matrix4& M,
                        ...
                        Matrix4& result) noexcept;
  static Matrix4 Transform(const Matrix4& M,
...
struct Quaternion : public XMFLOAT4
{
  ...
  void RotateTowards(const Quaternion& target,
                     float maxAngle,
  ...
  static void FromToRotation(const Vector3& fromDir,
                             const Vector3& toDir,
                             Quaternion& result) noexcept;
  static Quaternion FromToRotation(const Vector3& fromDir,
                                   const Vector3& toDir) noexcept;

  static void LookRotation(const Vector3& forward,
                           const Vector3& up,
                           Quaternion& result) noexcept;
...
public:
  ...
  Vector3 Project(const Vector3& p,
                  const Matrix4& proj,
                  const Matrix4& view,
                  const Matrix4& world) const noexcept;
