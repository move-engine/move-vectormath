#if !defined(MOVE_VECTORMATH_HPP_INCLUDED)
...
namespace DirectX::SimpleMath
{
    ...
    inline float vector2::length_squared() const noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat2(this);
    ...
    inline void vector2::Transform(
        const vector2& v, const Matrix4& m, vector2& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat2(&v);
    ...
    inline vector2 vector2::Transform(
        const vector2& v, const Matrix4& m) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat2(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    _Use_decl_annotations_ inline void vector2::Transform(const vector2* varray,
        size_t count, const Matrix4& m, vector2* resultArray) noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    inline void vector2::Transform(
        const vector2& v, const Matrix4& m, Vector4& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat2(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    _Use_decl_annotations_ inline void vector2::Transform(const vector2* varray,
        size_t count, const Matrix4& m, Vector4* resultArray) noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    _Use_decl_annotations_ inline void vector2::TransformNormal(
        const vector2* varray, size_t count, const Matrix4& m,
    ...
    inline void Vector3::Transform(
        const Vector3& v, const Matrix4& m, Vector3& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat3(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    inline Vector3 Vector3::Transform(
        const Vector3& v, const Matrix4& m) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat3(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    _Use_decl_annotations_ inline void Vector3::Transform(const Vector3* varray,
        size_t count, const Matrix4& m, Vector3* resultArray) noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    inline void Vector3::Transform(
        const Vector3& v, const Matrix4& m, Vector4& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat3(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    _Use_decl_annotations_ inline void Vector3::TransformNormal(
        const Vector3* varray, size_t count, const Matrix4& m,
    ...
    inline void Vector4::Transform(
        const Vector4& v, const Matrix4& m, Vector4& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat4(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    inline Vector4 Vector4::Transform(
        const Vector4& v, const Matrix4& m) noexcept
    {
        using namespace DirectX;
        const XMVECTOR v1 = XMLoadFloat4(&v);
        const XMMATRIX M = XMLoadFloat4x4(&m);
    ...
    inline Matrix4::Matrix4(const XMFLOAT3X3& M) noexcept
    {
        _11 = M._11;
        _12 = M._12;
        _13 = M._13;
    ...
    inline Matrix4::Matrix4(const XMFLOAT4X3& M) noexcept
    {
        _11 = M._11;
        _12 = M._12;
        _13 = M._13;
    ...
    inline Matrix4& Matrix4::operator=(const XMFLOAT3X3& M) noexcept
    {
        _11 = M._11;
        _12 = M._12;
        _13 = M._13;
    ...
    inline Matrix4& Matrix4::operator=(const XMFLOAT4X3& M) noexcept
    {
        _11 = M._11;
        _12 = M._12;
        _13 = M._13;
    ...
    inline Matrix4 Matrix4::operator-() const noexcept
    {
        using namespace DirectX;
    ...
    inline void Matrix4::Transpose(Matrix4& result) const noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(this);
    ...
    inline Matrix4 Matrix4::Invert() const noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(this);
        Matrix4 R;
    ...
    inline void Matrix4::Invert(Matrix4& result) const noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(this);
        XMVECTOR det;
    ...
    inline float Matrix4::Determinant() const noexcept
    {
        using namespace DirectX;
        const XMMATRIX M = XMLoadFloat4x4(this);
    ...
    inline Vector3 Matrix4::ToEuler() const noexcept
    {
    ...
    _Use_decl_annotations_ inline Matrix4 Matrix4::CreateBillboard(
    ...
    _Use_decl_annotations_ inline Matrix4 Matrix4::CreateConstrainedBillboard(
        const Vector3& object, const Vector3& cameraPosition,
    ...
    inline Matrix4 Matrix4::create_transformation_complex(
        const Vector3& scalingCenter, const Quaternion& scalingRotation,
        const Vector3& scaling, const Vector3& rotationCenter,
        const Quaternion& rotation, const Vector3& translation) noexcept
    {
        return XMMatrixTransformation(scalingCenter, scalingRotation, scaling,
            rotationCenter, rotation, translation);
    }

    inline Matrix4 Matrix4::create_model_matrix(const Vector3& scaling,
        const Quaternion& rotation, const Vector3& translation) noexcept
    {
        return create_transformation_complex(Vector3(0, 0, 0),
            Quaternion::identity(), scaling, Vector3(0, 0, 0), rotation,
            translation);
    }

    inline Matrix4 Matrix4::CreateTranslation(const Vector3& position) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
        XMStoreFloat4x4(
    ...
    inline Matrix4 Matrix4::CreateTranslation(
    ...
    inline Matrix4 Matrix4::CreateScale(const Vector3& scales) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateScale(float xs, float ys, float zs) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateScale(float scale) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateRotationX(float radians) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateRotationY(float radians) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateRotationZ(float radians) noexcept
    {
        using namespace DirectX;
        Matrix4 R;
    ...
    inline Matrix4 Matrix4::CreateFromAxisAngle(
    ...
    inline Matrix4 Matrix4::CreatePerspectiveFieldOfView(
    ...
    inline Matrix4 Matrix4::CreatePerspective(
    ...
    inline Matrix4 Matrix4::CreatePerspectiveOffCenter(float left, float right,
    ...
    inline Matrix4 Matrix4::CreateOrthographic(
    ...
    inline Matrix4 Matrix4::CreateOrthographicOffCenter(float left, float right,
    ...
    inline Matrix4 Matrix4::CreateLookAt(
    ...
    inline Matrix4 Matrix4::CreateWorld(const Vector3& position,
    ...
    inline Matrix4 Matrix4::CreateFromQuaternion(
    ...
    inline Matrix4 Matrix4::CreateFromYawPitchRoll(
    ...
    inline Matrix4 Matrix4::CreateShadow(
    ...
    inline Matrix4 Matrix4::CreateReflection(const Plane& plane) noexcept
    {
        using namespace DirectX;
        const XMVECTOR planev = XMLoadFloat4(&plane);
        Matrix4 R;
    ...
    inline void Matrix4::Lerp(
        const Matrix4& M1, const Matrix4& M2, float t, Matrix4& result) noexcept
    {
        using namespace DirectX;
        XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
        XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
    ...
    inline Matrix4 Matrix4::Lerp(
        const Matrix4& M1, const Matrix4& M2, float t) noexcept
    {
        using namespace DirectX;
        XMVECTOR x1 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._11));
        XMVECTOR x2 = XMLoadFloat4(reinterpret_cast<const XMFLOAT4*>(&M1._21));
    ...
    inline void Matrix4::transform(
        const Matrix4& M, const Quaternion& rotation, Matrix4& result) noexcept
    {
        using namespace DirectX;
        const XMVECTOR quatv = XMLoadFloat4(&rotation);
    ...
    inline Matrix4 Matrix4::transform(
        const Matrix4& M, const Quaternion& rotation) noexcept
    {
        using namespace DirectX;
        const XMVECTOR quatv = XMLoadFloat4(&rotation);
    ...
    inline void Plane::Transform(
        const Plane& plane, const Matrix4& M, Plane& result) noexcept
    {
        using namespace DirectX;
    ...
    inline Plane Plane::Transform(const Plane& plane, const Matrix4& M) noexcept
    {
        using namespace DirectX;
        const XMVECTOR p = XMLoadFloat4(&plane);
        const XMMATRIX m0 = XMLoadFloat4x4(&M);
    ...
    inline Vector3 Viewport::Project(const Vector3& p, const Matrix4& proj,
        const Matrix4& view, const Matrix4& world) const noexcept
    {
        using namespace DirectX;
    ...
    inline void Viewport::Project(const Vector3& p, const Matrix4& proj,
        const Matrix4& view, const Matrix4& world,
        Vector3& result) const noexcept
    {
        using namespace DirectX;
        XMVECTOR v = XMLoadFloat3(&p);
    ...
    inline Vector3 Viewport::Unproject(const Vector3& p, const Matrix4& proj,
        const Matrix4& view, const Matrix4& world) const noexcept
    {
        using namespace DirectX;
        XMVECTOR v = XMLoadFloat3(&p);
    ...
    inline void Viewport::Unproject(const Vector3& p, const Matrix4& proj,
        const Matrix4& view, const Matrix4& world,
        Vector3& result) const noexcept
    {
        using namespace DirectX;
