...
//     {
//         auto mat =
//         matrix_type::create_perspective_rh(1.0f, 2.0f, 3.0f, 4.0f); THEN("It
//         should match the DirectXMath perspective matrix")
//         {
//             auto mat_dxm =
//                 DirectX::XMMatrixPerspectiveFovRH(1.0f, 2.0f, 3.0f, 4.0f);
//             REQUIRE(equals(mat, mat_dxm));
...
//     {
//         auto mat =
//         matrix_type::create_perspective_lh(1.0f, 2.0f, 3.0f, 4.0f); THEN("It
//         should match the DirectXMath perspective matrix")
//         {
//             auto mat_dxm =
//                 DirectX::XMMatrixPerspectiveFovLH(1.0f, 2.0f, 3.0f, 4.0f);
...
//         {
//             auto mat_dxm =
//                 DirectX::XMMatrixLookAtRH(DirectX::XMVectorSet(10, 10, 10,
//                 0),
//                     DirectX::XMVectorSet(0, 0, 0, 0),
//                     DirectX::XMVectorSet(0, 1, 0, 0));
//             REQUIRE(equals(mat, mat_dxm));
...
//         {
//             auto mat_dxm =
//                 DirectX::XMMatrixLookAtLH(DirectX::XMVectorSet(10, 10, 10,
//                 0),
//                     DirectX::XMVectorSet(0, 0, 0, 0),
//                     DirectX::XMVectorSet(0, 1, 0, 0));
//             REQUIRE(equals(mat, mat_dxm));
...
//         auto mat = matrix_type::create_transformation(trans, rot, scale);
//         THEN(
//             "Multiplying a point by the matrix should yield the correct
//             result")
//         {
//             auto zero = DirectX::XMVectorSet(0, 0, 0, 0);
//             auto dxmtrans =
