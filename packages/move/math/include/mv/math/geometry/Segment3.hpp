...
namespace mv::math
{
    ...
    {
    public:
        Segment3f() noexcept = default;

        Segment3f(Point3f start, Point3f end) noexcept :
            Start_(start), End_(end)
        {
        }

        [[nodiscard]] const Point3f& Start() const noexcept
        {
            return Start_;
        }
        ...
        [[nodiscard]] Vec3f Displacement() const noexcept
        {
            return End_ - Start_;
        }
        ...
        [[nodiscard]] std::optional<Direction3f> TryDirection() const noexcept
        {
            return Direction3f::TryFrom(Displacement());
        }
        ...
        [[nodiscard]] Point3f PointAtFraction(float fraction) const noexcept
        {
        ...
        [[nodiscard]] friend bool operator==(const Segment3f& left,
                                             const Segment3f& right) noexcept
        {
