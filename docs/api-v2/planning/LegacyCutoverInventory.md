...
| Interpolation, clamp, reflect/refract, angle helpers | Ready | Practical scalar/vector interpolation, smoothing, clamp, reflect, refraction, and typed angles exist; native-lane Vec3 Min/Max preserves scalar NaN operand-order semantics, and further helpers remain workload-driven. |
