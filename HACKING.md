...
hidden if the `MOVE_VECTORMATH_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `MOVE_VECTORMATH_DEVELOPER_MODE` to the configure
