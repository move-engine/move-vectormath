...
hidden if the `move-vectormath_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `move-vectormath_DEVELOPER_MODE` to the configure
